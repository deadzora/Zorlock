	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	Zorlock::BufferLayout layout = {
		{ Zorlock::ShaderDataType::Float3, "a_Position" },
		{ Zorlock::ShaderDataType::Float4, "a_Color" }
	};
	...
	squareVB->SetLayout({
		{ Zorlock::ShaderDataType::Float3, "a_Position" },
		{ Zorlock::ShaderDataType::Float2, "a_TexCoord" }
		});
	...
	m_Shader = Zorlock::Shader::Create("VertexPosColor", vertexSrc, fragmentSrc);
